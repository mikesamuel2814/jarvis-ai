...
_NL_MAP: list[tuple[list[str], str]] = [
    ...
    (["disk space", "disk usage", "storage"], "disk"),
    (["memory usage", "ram usage", "show memory"], "memory"),
    (["uptime", "how long running"], "uptime"),
    (["gpu status", "gpu usage", "nvidia"], "gpu"),
    (["open ports", "listening ports"], "ports"),
    (["running services", "list services"], "services"),
    (["network", "ip address", "interfaces"], "network"),
    (["models", "ai models", "ollama models"], "ollama_models"),
    (["top cpu", "cpu usage"], "top5_cpu"),
    (["top memory", "memory processes"], "top5_mem"),
